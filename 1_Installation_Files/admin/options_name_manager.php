                ...
                if (($action === 'update_option') && ((int)$_GET['option_id'] === (int)$options_name['products_options_id'])) { ?>
                    ...
                    <tr>
                      ...
                      /* mc12345678 Attribute Image Swap Start 1 of 1 */
                                ['id' => '6', 'text' => TEXT_OPTION_ATTRIBUTE_IMAGES_STYLE_6],
                                ['id' => '7', 'text' => TEXT_OPTION_ATTRIBUTE_IMAGES_STYLE_7],
                                ['id' => '8', 'text' => TEXT_OPTION_ATTRIBUTE_IMAGES_STYLE_8],
                            ];
                      /* mc12345678 Attribute Image Swap End 1 of 1 */
                            ...
                            for ($i = 0, $n = count($languages); $i < $n; $i++) {
                                ...
                                $inputs2 .= zen_draw_pull_down_menu('products_options_images_style[' . $languages[$i]['id'] . ']', $productsOptionsImagesStyleArray, $option_name->fields['products_options_images_style'], 'class="form-control" style="width:100%" id="products_options_images_style[' . $languages[$i]['id'] . ']"');
                                $inputs2 .= '</div>';
                                $inputs2 .= '</div>';
                                $inputs2 .= '<br>';
